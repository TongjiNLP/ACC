...
from transformers import WEIGHTS_NAME,get_linear_schedule_with_warmup,AdamW,BasicTokenizer

from squad_evaluation import find_all_best_thresh, make_qid_to_has_ans, get_raw_scores
...
class SQuADProcessor(DataProcessor):
    ...
    def get_train_examples(self, data_dir):
        """Gets a collection of `InputExample`s for the train set."""
        return self.read_squad_examples(
...
def initialize(args):
    ...
    return args,processor,tokenizer,model

if __name__=="__main__":
    processor=SQuADProcessor()
    examples=processor.get_train_examples("./squad-baseline/squad")
    print(examples[0])